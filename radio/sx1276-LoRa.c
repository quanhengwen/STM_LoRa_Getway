...
tLoRaSettings LoRaSettings =
{
    ...
    100,              // TxPacketTimeout
    100,              // RxPacketTimeout
    9,              // PayloadLength (used for implicit header mode)
};
...
//		uint32_t result = RFLR_STATE_RX_TIMEOUT;
//		uint8_t DIO_bool=1;
//     case RFLR_STATE_TX_INIT:

        SX1276LoRaSetOpMode( RFLR_OPMODE_STANDBY );
				
        SX1276Write(0x0A,0x08);
